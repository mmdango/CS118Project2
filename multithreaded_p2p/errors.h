 ...
 * examples. When compiled -DDEBUG, it rebults in calling printf
...
/* NOTE: the "do {" ... "} while(0);" bracketing around macros
 ...
 * generate a null satement. For example,
 *
 *     if (status != 0)
